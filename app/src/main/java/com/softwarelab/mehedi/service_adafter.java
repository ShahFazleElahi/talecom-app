...
import com.softwarelab.mehedi.view.MainActivityc;
...
public class service_adafter extends BaseAdapter {
    ...
    public View getView(final int i, View view, ViewGroup viewGroup) {
        ...
        if (this.resultp.get(Welcome.act).indexOf("recharge") >= 0) {
            imageView.setImageDrawable(ContextCompat.getDrawable(this.context, R.drawable.fexiload));
        } else if (this.resultp.get(Welcome.act).indexOf("drive") >= 0) {
            imageView.setImageDrawable(ContextCompat.getDrawable(this.context, R.drawable.gift));
        } else if (this.resultp.get(Welcome.act).indexOf("internet") >= 0) {
            textView.setText("Regular pack");
            imageView.setImageDrawable(ContextCompat.getDrawable(this.context, R.drawable.gifts));
