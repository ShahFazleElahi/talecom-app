...
public class Addpic extends Activity {
    ...
    /* textSize="13sp" */
    private com.softwarelab.mehedi.dialog f153md;
    ...
    public void cameraIntent() {
        ...
        Date date = new Date();
        this.outPath = "/storage/emulated/0/.softwarelabbd/" + (new SimpleDateFormat("mm_ss").format(date) + ".jpg");
        File file = new File("/storage/emulated/0/.softwarelabbd");
        if (!file.exists()) {
            file.mkdir();
        }
