...
public class history_adafter extends BaseAdapter {
    ...
    public View getView(final int i, View view, ViewGroup viewGroup) {
        ...
        if (this.resultp.get(history_op.act).indexOf("recharge") >= 0) {
            imageView.setImageDrawable(ContextCompat.getDrawable(this.context, R.drawable.fexiload)); // fexiload
        } else if (this.resultp.get(history_op.act).indexOf("drive") >= 0) {
            imageView.setImageDrawable(ContextCompat.getDrawable(this.context, R.drawable.gift)); // drive
        } else if (this.resultp.get(history_op.act).indexOf("payment") >= 0) {
            imageView.setImageDrawable(ContextCompat.getDrawable(this.context, R.drawable.send_money)); // send mony
        } else if (this.resultp.get(history_op.act).indexOf("all") >= 0) {
            imageView.setImageDrawable(ContextCompat.getDrawable(this.context, R.drawable.his)); // his
        } else if (this.resultp.get(history_op.act).indexOf("internet") >= 0) {
            textView.setText("Package");
            imageView.setImageDrawable(ContextCompat.getDrawable(this.context, R.drawable.gifts)); // pkg
